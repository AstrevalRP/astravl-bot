...
module.exports = {
    ...
    async execute(interaction : CommandInteraction) {
        ...
        const addPollChoiceButton = new ButtonBuilder()
            .setCustomId('add-poll-choice-button')
            .setEmoji('➕')
            .setStyle(ButtonStyle.Primary);
        const removePollChoiceButton = new ButtonBuilder()
        ...
        await interaction.reply({
            embeds: [embed],
            components: [new ActionRowBuilder<ButtonBuilder>().addComponents(addPollChoiceButton, removePollChoiceButton, GlobalUI.cancelButton), 
